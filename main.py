...
def main():
    ...
    for root, dirs, files in os.walk(masterFolder):
        ...
        for file in files:
                ...
                if ('original' in root):
                    print("DIR NUMBER: ", dir, " | FILE NUMBER: ", filecount, " | ERROR  | ORIGINAL FILE PATH FOUND")
                    filecount += 1
                    continue

                if ('unknown' in root):
                    print("DIR NUMBER: ", dir, " | FILE NUMBER: ", filecount, " | ERROR  | UNKNOWN FILE PATH FOUND")
                    filecount += 1
                    continue
                ...
                if file.endswith(".smali"):
                    ...
                    if file.lower().startswith("mraid"):
                        pass
                    else:
                        print("DIR NUMBER: ", dir, " | FILE NUMBER: ", filecount, " | SMALI  | FILE PATH: ", filePath)
                        filecount += 1
                        smaliparser.runsmaliParser(fileLabel, filePath)
